...
const Footer = () => {
  return (
    <div className='bg-[#091e20] text-white md:flex justify-center items-center md:h-[50vh] py-2 w-full'>
      <div className='max-w-[1440px] h-[full] md:flex border border-white justify-between  mx-auto  p-1 m-1 gap-2'>
        <div className='md:w-[40rem]  md:p-3 p-1 border border-white'>
            <h2>Ags Sofas</h2>
